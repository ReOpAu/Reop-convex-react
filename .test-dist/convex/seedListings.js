...
export const createSeedListing = internalMutation({
    args: {
        listing: v.object({
            ...
            longitude: v.number(),
            geohash: v.string(),
            buildingType: v.union(v.literal("House"), v.literal("Apartment"), v.literal("Townhouse"), v.literal("Villa"), v.literal("Unit")),
            bedrooms: v.number(),
            bathrooms: v.number(),
            parking: v.number(),
            priceMin: v.number(),
            priceMax: v.number(),
            features: v.array(v.union(v.literal("CornerBlock"), v.literal("EnsuiteBathroom"), v.literal("MatureGarden"), v.literal("LockUpGarage"), v.literal("Pool"), v.literal("SolarPanels"), v.literal("RenovatedKitchen"), v.literal("AirConditioning"), v.literal("HighCeilings"), v.literal("WaterViews"), v.literal("StudyRoom"), v.literal("OpenPlanLiving"), v.literal("SecuritySystem"), v.literal("EnergyEfficient"), v.literal("NorthFacing"), v.literal("PetFriendly"), v.literal("WheelchairAccessible"), v.literal("SmartHome"), v.literal("Fireplace"), v.literal("WalkInWardrobe"), v.literal("LanewayAccess"), v.literal("Bungalow"), v.literal("DualLiving"), v.literal("GrannyFlat"), v.literal("HeritageListed"), v.literal("RainwaterTank"), v.literal("DoubleGlazedWindows"), v.literal("HomeTheatre"), v.literal("WineCellar"), v.literal("OutdoorKitchen"))),
        ...
        for (let i = 0; i < matchPairCount; i++) {
            ...
            await ctx.runMutation(internal.seedListings.createSeedListing, {
                listing: {
                    ...
                    contactPhone: `04${Math.floor(Math.random() * 100000000)
                        .toString()
                        .padStart(8, "0")}`,
                    isActive: true,
