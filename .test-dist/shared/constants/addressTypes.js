...
export const STREET_KEYWORD_REGEXES = STREET_KEYWORDS.map((keyword) => new RegExp(`\\b${keyword}\\b`, "i"));
// Rural indicators
...
export const RURAL_KEYWORD_REGEXES = RURAL_KEYWORDS.map((keyword) => new RegExp(`\\b${keyword}\\b`, "i"));
