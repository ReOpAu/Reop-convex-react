// Shared Google Places / address-search helpers.
// These utilities are transport-agnostic so both Convex actions and native app
// server endpoints can reuse the same search, scoring, and validation logic.
